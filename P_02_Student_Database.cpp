...
class student
{
	...
	void getdata();//function declear
	friend void display(student & obj);//declear
	...
	int student :: count=0;//intialize the out side of class static data member
...
int main()
{
	...
	cout<<"\n---------------------------------------------------------------------";
	cout<<"\nROLL NO\tNAME\tDOB\tBLOOD GRP\tCLASS\tDIVISION\tCONTACT NO";
	display(s1);
cout<<"\n---------------------------------------------------------------------";

	int i,n;

	student *s[50];//integer array of pointer
